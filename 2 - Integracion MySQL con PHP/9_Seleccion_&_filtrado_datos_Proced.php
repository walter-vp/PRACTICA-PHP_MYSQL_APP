...
<!--    Objetivo del aplicativo:
        Seleccionar y filtrar datos de una tabla usando el Metodo: Procedimiento de MySQLi -->
...
<body>
    ...
    if(!$conn){
        ...
        echo "<h1>"."Conexion exitosa - Metodo: Procedimiento de MySQLi"."</h1>";
    };
    ...
    //Verifica si se devuelve más de cero filas
