...
<body>
    ...
    try {
        ...
        //Verificanción conexión con el servidor
        $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
        echo "<h1>" ."Conexion exitosa - Metodo: DOP de PHP" . "</h1>";

        //Preparar y unir declaraciones
        $stmt = $conn->prepare("SELECT id, firstname, lastname, email, reg_date FROM misinvitados");
