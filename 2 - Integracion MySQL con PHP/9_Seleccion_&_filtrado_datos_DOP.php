...
<!--    Objetivo del aplicativo:
        Seleccionar y filtrar datos de una tabla usando el Metodo: DOP -->
...
<body>
    ...
    try{
        ...
        $stmt= $conn->prepare("SELECT id,firstname, lastname, email, reg_date FROM misinvitados WHERE id > 50 and id < 80");
